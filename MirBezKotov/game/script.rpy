...
label da:
    ...
    scene black
    with flash
    #звуки жёстких оргазмов и звук звона в ушах
    "..."
    "Последнее, что промелькнуло перед глазами Матвея - это перепуганное лицо своего любимого петушка. "
    matwei "Ч"
    matwei "Что?"
    matwei "Всё уже кончилось?"
    matwei "Чо за хуйня"
    "Матвей загрустил.."
    "Ему стало невыносимо обидно, что мечта его детства так молниеносно закончилась.."
    "Матвей даже пустил скупую голубую слезу, словно мариупольский детдомовец, которому русский солдат не стрельнул сижку.."
    "..."
    "Неизвестно сколько точно, но довольно продолжительное время матвей не решался открыть глаза"
    "Ему было плевать"
    "..."
    matwei "Ну ебана мать..."
    matwei "Ладно, хуй с ним, всё таки мохнатые писечки были лучше."
    "Матвея резко захлыстнуло рвение к жизни."
    matwei "Пора просыпаться"
    matwei "Дерьмовый мир блядей и задолазов, встречай меня!!!"
    scene marshrutka
    with dissolve #анимация открытия глаз
    matwei "ух ты"
    matwei "ух ты бля"
    matwei "Где я?"
    matwei "Светло тут..."
    ...
    matwei "Глаза болят."
    matwei "Так."
    matwei "Я ж вроде не пил"
    matwei "Так какого спрашивается хуя я делаю в маршрутке?"
    matwei "Ещё и стоя умудрился отоспаться..."
    "Матвей дал ёбу"
    matwei "Стопэ, стоп"
    matwei "Кажется, я начинаю вспоминать.."
    matwei "Шош там было то"
    matwei "А"
    matwei "Аааа"
    matwei "Школьная дискотека, водка ииии"
    matwei "АНДРЕЙКА!!"
    matwei "Андрончик боже, ёбен бобен!"
    matwei "Ойебяка то какая..."
    "Матвей вcпомнил всё"
    matwei "Ха"
    matwei "Ха-ха-ха"
    matwei "ХАХХАХАХХАХХЫХАХФХЫАФХАХХАА XD))))"
    "Не поддающийся контролю смех захватил центральную нервую систему Матвейчика"
    "До боли в животе он угарал и катался по полу обоссаной маршрутки"
    matwei "Хуесос ёбаный хаха"
    matwei "Дирижёр имени вафельного оркестра ёпта"
    matwei "Ротоприёмник хехе"
    "Около 15-ти минут матвей придумывал скучные каламбурики и смехуёчки."
    "Ещё никогда в жизни он не позволял себе этого"
    "Ведь беда в том, что в обычной ситуации он был бы перманентно послан нахуй."
    matwei "Ух, всё, отпустило кажись"
    "Вставить звук пердежа"
    "Зловонище заполонило пропёрженную овощевозку настолько быстро, что даже наступление эакуляции Матвея дало бы ему прикурить."
    matwei "Фу бля"
    matwei "Пора выбираться на свет божий"
    matwei "Заебался я хуйней страдать, пойду-ка погуляю-ка"
    "Дальше завтра доделаем"
