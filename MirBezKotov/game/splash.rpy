image logo:
    ...
    subpixel True
    xcenter 0.5
    ycenter 0.3 # положение лого по оси хуигрик
...
label splashscreen:
    ...
    show logo with moveinbottom

    $ renpy.pause(0.5,hard=True) # время перед появлением текста

    show text"{size=72}ПРЕДСТАВЛЯЮТ" with moveinbottom: # там размер шрифта текст блять иди нахуй сам разберешься
        subpixel True
        yalign .7 # положение текста по оси хуигрик
        xalign .5 
